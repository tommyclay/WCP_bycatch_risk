...
The following repository contains codes to derive spatial locations based on light-based geolocation for White-chinned petrels _Procellaria aequinoctialis_, and processed geolocator datasets, submitted to Ecological Applications (Rexer-Huber, Clay, et al.). Scripts were customised by R. Ramos and K. Rexer-Huber following Z. Zajkova (unpubl. R scripts for GLS 2015). 
